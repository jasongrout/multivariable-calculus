...
\newcommand{\prepproblems}[1]{\marginpar{\fbox{\parbox{\marginparwidth}{\textbf{Preparation Problems} #1}}}}
...
\include{01-Curves-Coordinates-Differentials/Curves-Coordinates-Differentials}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{01-Curves-Coordinates-Differentials/Curves-Coordinates-Differentials-Problems}
\restoregeometry


\include{02-Vectors/Vectors}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{02-Vectors/Vectors-Problems}
\restoregeometry

\include{03-Functions/Functions-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{03-Functions/Functions-Problems}
\restoregeometry

\include{04-Derivatives/Derivatives-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{04-Derivatives/Derivatives-Problems}
\restoregeometry

\include{05-Motion/Motion-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{05-Motion/Motion-Problems}
\restoregeometry

\include{06-LineIntegrals/LineIntegrals-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{06-LineIntegrals/LineIntegrals-Problems}
\restoregeometry


\include{07-GradientFields/GradientFields-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{07-GradientFields/GradientFields-Problems}
\restoregeometry

\include{08-Optimization/Optimization-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{08-Optimization/Optimization-Problems}
\restoregeometry

\include{09-DoubleIntegrals/DoubleIntegrals-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{09-DoubleIntegrals/DoubleIntegrals-Problems}
\restoregeometry
